...
function loadWidget(config) {
	...
	document.body.insertAdjacentHTML("beforeend", `<div id="waifu">
			...
			<canvas id="live2d" width="1000" height="1200"></canvas>
			<div id="waifu-tool">
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			else if (domain === "google") text = `Hello！来自 谷歌搜索 的朋友<br>欢迎光临<span>「${document.title.split(" - ")[0]}」</span>`;
			else text = `Hello！来自 <span>${referrer.hostname}</span> 的朋友`;
		} else {
			text = `欢迎光临<span>「${document.title.split(" - ")[0]}」</span>`;
		}
...
function initWidget(config, apiPath = "/") {
	...
	document.body.insertAdjacentHTML("beforeend", `<div class="live2d-tool hide-live2d no-select" id="show_model"><div class="keys"style="font-size: 0;">Hide</div></div>
		<div class="live2d-tool live2d-pio no-select" id="switch_live2d"><div class="keys"style="font-size: 0;">Switch</div></div>
		<div id="switch_model"><!--class="live2d-tool switch-live2d no-select" <div class="keys">Switch</div>--></div>
		<div class="live2d-tool save-live2d no-select" id="save_pic"><div class="keys"style="font-size: 0;">Save</div></div>
		`);
